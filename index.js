...
const images = [
    { 'id': '1', 'url':'./img/coliseu-ok.png' },
    { 'id': '2', 'url':'./img/liberdade-ok.png' },
    { 'id': '3', 'url':'./img/lisboa-ok.png' },
    { 'id': '4', 'url':'./img/louvre-ok.png' },
    { 'id': '5', 'url':'./img/rio-ok.png' },
    { 'id': '6', 'url':'./img/torre-ok.png' },
]
